...
*** ******************************;
IF MISSING( RESPOND1 ) THEN R_RESPOND1  = . ;
ELSE R_RESPOND1  = RESPOND1  - P_RESPOND1 ;
IF MISSING( RESPOND0 ) THEN R_RESPOND0  = . ;
ELSE R_RESPOND0  = RESPOND0  - P_RESPOND0 ;
*** *************************;
