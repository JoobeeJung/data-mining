...
%let EM_NUM_VARS = 17;
   %macro EM_VARS;
    BUY12 BUY18 BUY6 CLIMATE COA6 DISCBUY IMP_AGE IMP_FICO IMP_INCOME IMP_MARRIED
   IMP_ORGSRC IMP_OWNHOME IMP_SEX LOC RESPOND RETURN24 VALUE24
   %mend EM_VARS;
%let EM_NUM_CLASS = 10;
   %macro EM_CLASS;
    CLIMATE COA6 DISCBUY IMP_MARRIED IMP_ORGSRC IMP_OWNHOME IMP_SEX LOC RESPOND
   RETURN24
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 7;
   %macro EM_INTERVAL;
    BUY12 BUY18 BUY6 IMP_AGE IMP_FICO IMP_INCOME VALUE24
   %mend EM_INTERVAL;
...
%let EM_NUM_INPUT = 16;
   %macro EM_INPUT;
    BUY12 BUY18 BUY6 CLIMATE COA6 DISCBUY IMP_AGE IMP_FICO IMP_INCOME IMP_MARRIED
   IMP_ORGSRC IMP_OWNHOME IMP_SEX LOC RETURN24 VALUE24
   %mend EM_INPUT;
%let EM_NUM_BINARY_INPUT = 6;
   %macro EM_BINARY_INPUT;
    COA6 DISCBUY IMP_MARRIED IMP_OWNHOME IMP_SEX RETURN24
